...
namespace Poke.Logic.DB
{
	public static class DBWorker
	{
		...
		static SqliteConnection Connection = new SqliteConnection("Data Source=Poke.db"); //TODO: Fix da error
		public static long CreaturesCount {
		get
		{
		...
		public static long gdsCreaturesCount()
		{
		...
		{
			SqliteConnection Connection = new SqliteConnection("Data Source=Poke.db");
